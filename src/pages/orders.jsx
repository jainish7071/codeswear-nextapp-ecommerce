...
const Orders = () => {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      let a = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/my-orders`, {
        method: "POST",
        headers: {
              ...
              <div className="overflow-hidden">
                <table className="min-w-full text-left text-sm font-light">
                  ...
                  <tbody>
                    {orders.map((item) => {
                      return (
                        <tr key={item._id} className="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
